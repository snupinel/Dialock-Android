...
👉 [📌 Download v0.8.3](https://github.com/snupinel/Dialock-Android/releases/download/v0.8.3/app-debug.apk)
...
| 버전 | 상태 | 주요 변경 사항 |
|------|------|---------------|
| [**v0.8.3**](https://github.com/snupinel/Dialock-Android/releases/tag/v.0.8.3) | 개발용 | 최초 시간 설정 화면 구현 및 캘린더 최적화 |
